...
public class CommunityAdapter extends RecyclerView.Adapter<CommunityAdapter.HolderCommunityChat> {
    private Context context;
    private ArrayList<CommunityChat> CommunityChatList;

    public CommunityAdapter(Context context, ArrayList<CommunityChat> CommunityChatList) {
