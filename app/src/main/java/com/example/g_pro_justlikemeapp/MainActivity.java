...
import com.example.g_pro_justlikemeapp.Fragments.ChatsFragment;
import com.example.g_pro_justlikemeapp.Fragments.CommunityFragment;
import com.example.g_pro_justlikemeapp.Fragments.ProfileFragment;
import com.example.g_pro_justlikemeapp.Fragments.UsersFragment;
...
String mUID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        viewPagerAdapter.addFragment(new CommunityFragment(), "V-Comm");
        ...
        reference2=FirebaseDatabase.getInstance().getReference("V_Comm").child(firebaseUser.getUid());
        reference2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                CommunityChat Com=snapshot.getValue(CommunityChat.class);
